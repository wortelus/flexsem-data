...
def generate_major_minor_loop_trajectory(axis: str,
    ...
    for major_step, minor_step in distance_step_list:
...
def run(cfg: Settings, sem_cfg: FlexSEMSettings):
    ...
    MAJOR_MINOR_LOOP_STEPS = [
        ...
        (Distance.from_nanometers(2000), Distance.from_nanometers(200)),
        (Distance.from_nanometers(1000), Distance.from_nanometers(100)),
