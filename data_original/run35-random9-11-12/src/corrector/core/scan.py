...
def scan(
    ...
    # Wait for exposure time if specified
    # if exposure_time_s:
...
def correction_scan(
    ...
    return scan(
        cfg, cmd_factory, manager, cfg.drift.correction_type, "c", exposure_time_s=None
    )
...
def exposure_scan(
    ...
    return scan(cfg, cmd_factory, manager, exp_type, "e", step.exposure_time_s)
