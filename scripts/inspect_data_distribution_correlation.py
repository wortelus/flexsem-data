...
FILES = [
    ...
    f"{FILES_ROOT}/run34-random678mag/no_outlier_segments/run34_iteration1_part001_steps0000-0003.jsonl",
    f"{FILES_ROOT}/run34-random678mag/no_outlier_segments/run34_iteration1_part002_steps0005-0083.jsonl",
    f"{FILES_ROOT}/run34-random678mag/no_outlier_segments/run34_iteration1_part003_steps0085-0087.jsonl",
    f"{FILES_ROOT}/run34-random678mag/no_outlier_segments/run34_iteration1_part004_steps0089-0217.jsonl",
    f"{FILES_ROOT}/run34-random678mag/no_outlier_segments/run34_iteration1_part005_steps0219-0425.jsonl",
    f"{FILES_ROOT}/run34-random678mag/no_outlier_segments/run34_iteration1_part006_steps0427-0449.jsonl",
    f"{FILES_ROOT}/run34-random678mag/no_outlier_segments/run34_iteration1_part007_steps0451-0457.jsonl",
    f"{FILES_ROOT}/run34-random678mag/no_outlier_segments/run34_iteration1_part008_steps0459-end.jsonl",
    f"{FILES_ROOT}/run34-random678mag/no_outlier_segments/run34_iteration2_part001_steps0000-end.jsonl",
    f"{FILES_ROOT}/run34-random678mag/no_outlier_segments/run34_iteration3_part001_steps0000-end.jsonl",
    ...
    f"{FILES_ROOT}/run84-random-walk/hysteresis_dataset_20260817_224830_446197_updated.jsonl",
    f"{FILES_ROOT}/run85-random-walk/hysteresis_dataset_20260818_143513_530862_updated.jsonl",
]
